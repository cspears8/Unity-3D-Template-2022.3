...
namespace DS.Utilities
{
    ...
    public static class DSIOUtility
    {
        ...
        private static void SaveGroupToScriptableObject(DSGroup group, DSDialogueContainerSO dialogueContainer)
        {
            ...
            DSDialogueGroupSO dialogueGroup = CreateAsset<DSDialogueGroupSO>($"{containerFolderPath}/Groups/{groupName}", "Dialogues");
        ...
        {
            CreateFolder("Asset/Editor/DialogueSystem", "Graphs");
